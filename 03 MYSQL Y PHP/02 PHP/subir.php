        ...
        <div class="row justify-content-center">
            ...
            <?php
                if(isset($_POST['guardar'])){
                    ...
                    $query_guardar = "INSERT INTO peliculas (peli_nombres, peli_genero, peli_estreno, peli_restricciones, peli_dire_id, peli_img) VALUES ('{$peli_nombre}', '{$peli_genero}', '{$peli_estreno}', '{$peli_restricciones}', {$peli_dire_id}, '{$peli_img}')";
                }
            ?>
        </div>
    </section>
